...
export default function ResetPasswordPage() {
  ...
  const requestReset = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(
        "https://rekogrinikfrontbeck-production-a699.up.railway.app/api/v1/auth/request-password-reset",
        {
          method: "POST",
  ...
  const setNewPass = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(
        "https://rekogrinikfrontbeck-production-a699.up.railway.app/api/v1/auth/reset-password-code",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
