...
export default function BeforeAfterPage() {
  ...
  const fetchPhotos = async () => {
    try {
      ...
      const url = `http://rekogrinikfrontbeck-production-cf17.up.railway.app/api/v1/public/gallery/albums/before-after?t=${timestamp}`;
    ...
    input.onchange = async (e) => {
      ...
      try {
        ...
        const pairsResponse = await fetch(
          `http://rekogrinikfrontbeck-production-cf17.up.railway.app/api/v1/public/gallery/albums/before-after`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
        ...
        if (!pair) {
          ...
          const uploadResponse = await fetch(
            "http://rekogrinikfrontbeck-production-cf17.up.railway.app/api/v1/upload/photo",
            {
              method: "POST",
              headers: {
                Authorization: `Bearer ${token}`,
        ...
        const endpoint = isBeforePhoto
          ? `http://rekogrinikfrontbeck-production-cf17.up.railway.app/api/v1/upload/pairs/${pair.id}/before`
          : `http://rekogrinikfrontbeck-production-cf17.up.railway.app/api/v1/upload/pairs/${pair.id}/after`;
  ...
  const deleteSpecificCollection = async (collectionId: number) => {
    ...
    try {
      ...
      const deleteResponse = await fetch(
        `http://rekogrinikfrontbeck-production-cf17.up.railway.app/api/v1/gallery/albums/${albumId}/collections/${collectionId}?deletePhotos=true`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
